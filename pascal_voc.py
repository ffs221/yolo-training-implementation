...
class pascal_voc(object):
    ...
    def get(self):
        images = np.zeros(
            (self.batch_size_0, self.image_size, self.image_size, 3))
        labels = np.zeros(
            (self.batch_size_0, self.cell_size, self.cell_size, 25))
        count = 0
        while count < self.batch_size_0:
